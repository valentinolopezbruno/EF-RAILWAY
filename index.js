...
app.get("/productos", async (req, res) => {
  ...
  for (let i = 0; i < social.length; i++) {
    ...
    if (fs.existsSync(pathImage)) {
      RedSocial.imagen = `https://ef-railway-production.up.railway.app/imagenes/` + RedSocial.imagen;  
    } else {
      RedSocial.imagen = `https://ef-railway-production.up.railway.app/imagenes/mistake.jpg`; 
    }
    data.push(RedSocial);
      ...
      for (let g = 0; g < data.length; g++) {
        if (data[g].idSocial == productos[j].id_social) {
          ...
          if (!existeProducto) {
            ...
            if (fs.existsSync(pathImage)) {
              producto.imagen =
              `https://ef-railway-production.up.railway.app/imagenes/` + producto.imagen; 
            } else {
              producto.imagen = `https://ef-railway-production.up.railway.app/imagenes/mistake.jpg`;  
            }
